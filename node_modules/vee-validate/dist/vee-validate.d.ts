...
import { Ref, ComputedRef, PropType, DeepReadonly, InjectionKey } from 'vue';
...
declare type SubmissionHandler<TValues extends Record<string, unknown> = Record<string, unknown>, TReturn = unknown> = (values: TValues, ctx: SubmissionContext<TValues>) => TReturn;
declare type RawFormSchema<TValues> = Record<keyof TValues, string | GenericValidateFunction | Record<string, any>>;
declare type FieldPathLookup<TValues extends Record<string, any> = Record<string, any>> = Partial<Record<keyof TValues, PrivateFieldContext>>;
...
declare const Form: vue.DefineComponent<{
    ...
    onSubmit: {
        type: PropType<SubmissionHandler<Record<string, unknown>, unknown>>;
        default: any;
    };
}, () => vue.VNode<vue.RendererNode, vue.RendererElement, {
    [key: string]: any;
...
declare function useFieldArray<TValue = unknown>(opts: FieldArrayOptions): FieldArrayContext;
 ...
 */
declare function useFieldValue<TValue = unknown>(path?: MaybeRef<string>): {
    value: vue.ComputedRef<TValue>;
 ...
 */
declare function useFormValues<TValues extends Record<string, unknown> = Record<string, unknown>>(): {
    values: vue.ComputedRef<Partial<TValues>>;
