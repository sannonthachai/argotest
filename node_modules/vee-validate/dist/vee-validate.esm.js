/**
  ...
  * @license MIT
  */
import { inject, getCurrentInstance, warn as warn$1, ref, unref, computed, reactive, watch, onUnmounted, nextTick, onMounted, provide, isRef, onBeforeUnmount, defineComponent, toRef, resolveDynamicComponent, h, markRaw, readonly, toRefs } from 'vue';
...
function useCheckboxField(name, rules, opts) {
    ...
    function patchCheckboxApi(field) {
        ...
        return Object.assign(Object.assign({}, field), { checked,
            checkedValue,
            uncheckedValue, originalHandleChange: handleChange, handleChange: handleCheckboxChange });
    }
    if (!form) {
...
function useForm(opts) {
    ...
    async function validate(opts) {
        ...
        const validations = await Promise.all(Object.values(fieldsByPath.value).map(field => {
            ...
            return field.validate(opts).then((result) => {
                return {
...
function useFieldValue(path) {
    ...
    function setValue(newValue) {
        if (path) {
            form === null || form === void 0 ? void 0 : form.setFieldValue(unref(path), newValue);
            return;
        }
