 ...
 * Add module
 */
export declare function addFinder(finder: IconifyFinder): void;
/**
 ...
 */
export declare function cleanIconName(name: IconifyIconName | string | null): IconifyIconName | null;
/**
 * Find all placeholders
 */
export declare function findPlaceholders(root: HTMLElement): PlaceholderElement[];
