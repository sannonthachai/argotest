...
var require_dist = _chunkYGRTKXPZjs.__commonJS.call(void 0, {
...
// src/core/utils.ts
var import_utils = _chunkYGRTKXPZjs.__toModule.call(void 0, require_dist());
...
function matchGlobs(filepath, globs) {
  for (const glob of globs) {
    if (_minimatch2.default.call(void 0, (0, import_utils.slash)(filepath), glob))
      return true;
  }
  return false;
}
...
function getNameFromFilePath(filePath, options) {
  ...
  const parsedFilePath = _path.parse.call(void 0, (0, import_utils.slash)(filePath));
  let strippedPath = "";
...
function getPkgVersion(pkgName, defaultVersion) {
  try {
    return _chunkYGRTKXPZjs.__require.call(void 0, `${pkgName}/package.json`).version;
  } catch (err) {
    console.error(err);
