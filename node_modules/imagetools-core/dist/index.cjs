...
const positionValues = ['top', 'right top', 'right', 'right bottom', 'bottom', 'left bottom', 'left', 'left top',
    ...
    'entropy', 'attention'];
const positionShorthands = ['top', 'right top', 'right', 'right bottom', 'bottom', 'left bottom', 'left', 'left top'];
...
const builtins = [blur, flatten, flip, flop, format, grayscale, hsb, invert, median, normalize, resize, rotate, tint];
...
const metadataFormat = (metadatas) => {
 ...
 */
function resolveConfigs(entries) {
